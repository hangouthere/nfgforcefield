...
execute unless entity @p[distance=1..5] run tellraw @a ["",{"text":"[nfgForceField] ","color":"gold"},{"text":"Error","color":"red"},{"text":": No Player detected to modify their permissions. Make sure a Player is within 5 blocks of you."}]
