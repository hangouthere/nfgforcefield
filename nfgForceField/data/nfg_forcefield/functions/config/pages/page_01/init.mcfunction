...
## Books
# Allied Incoming
execute if entity @p[tag=ff_configuring,nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.10 air
...
# Allied Leaving
execute if entity @p[tag=ff_configuring,nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.11 air
...
# Stranger Incoming
execute if entity @p[tag=ff_configuring,nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.15 air
...
# Stranger Leaving
execute if entity @p[tag=ff_configuring,nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.16 air
