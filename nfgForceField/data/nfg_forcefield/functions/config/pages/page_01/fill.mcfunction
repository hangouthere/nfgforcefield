...
## Books
# Allied Entering
execute if entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.10 air
execute unless entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.10 writable_book{display:{Name:'[{"text":"Allied Entering ","color":"green"},{"text":"Messages","color":"white"}]',Lore:['{"text":" "}','{"text":"Configure Messages with this book,","color":"white"}','{"text":"and place it back in the same slot","color":"white"}','{"text":"when you\'re done, or it won\'t save!","color":"white"}','{"text":" "}','{"text":"Page 1: Large Title Text","color":"gray"}','{"text":"Page 2: Medium Subtitle Text","color":"gray"}','{"text":"Page 3: Smaller Action Text","color":"gray"}','{"text":"Page 4: Server Chat","color":"gray"}']},HideFlags:127,ff:{messages:1b,direction:1b,allied:1b},pages:[]}
# Allied Leaving
execute if entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.11 air
execute unless entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:1b}}}]}] run replaceitem block ~ ~ ~ container.11 writable_book{display:{Name:'[{"text":"Allied ","color":"green"},{"text":"Leaving ","color":"red"},{"text":"Messages","color":"white"}]',Lore:['{"text":" "}','{"text":"Configure Messages with this book,","color":"white"}','{"text":"and place it back in the same slot","color":"white"}','{"text":"when you\'re done, or it won\'t save!","color":"white"}','{"text":" "}','{"text":"Page 1: Large Title Text","color":"gray"}','{"text":"Page 2: Medium Subtitle Text","color":"gray"}','{"text":"Page 3: Smaller Action Text","color":"gray"}','{"text":"Page 4: Server Chat","color":"gray"}']},HideFlags:127,ff:{messages:1b,direction:0b,allied:1b},pages:[]}
# Stranger Entering
execute if entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.15 air
execute unless entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:1b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.15 writable_book{display:{Name:'[{"text":"Stranger ","color":"yellow"},{"text":"Entering ","color":"green"},{"text":"Messages","color":"white"}]',Lore:['{"text":" "}','{"text":"Configure Messages with this book,","color":"white"}','{"text":"and place it back in the same slot","color":"white"}','{"text":"when you\'re done, or it won\'t save!","color":"white"}','{"text":" "}','{"text":"Page 1: Large Title Text","color":"gray"}','{"text":"Page 2: Medium Subtitle Text","color":"gray"}','{"text":"Page 3: Smaller Action Text","color":"gray"}','{"text":"Page 4: Server Chat","color":"gray"}']},HideFlags:127,ff:{messages:1b,direction:1b,allied:0b},pages:[]}
# Stranger Leaving
execute if entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.16 air
execute unless entity @s[nbt={Inventory:[{tag:{ff:{messages:1b,direction:0b,allied:0b}}}]}] run replaceitem block ~ ~ ~ container.16 writable_book{display:{Name:'[{"text":"Stranger ","color":"yellow"},{"text":"Leaving ","color":"red"},{"text":"Messages","color":"white"}]',Lore:['{"text":" "}','{"text":"Configure Messages with this book,","color":"white"}','{"text":"and place it back in the same slot","color":"white"}','{"text":"when you\'re done, or it won\'t save!","color":"white"}','{"text":" "}','{"text":"Page 1: Large Title Text","color":"gray"}','{"text":"Page 2: Medium Subtitle Text","color":"gray"}','{"text":"Page 3: Smaller Action Text","color":"gray"}','{"text":"Page 4: Server Chat","color":"gray"}']},HideFlags:127,ff:{messages:1b,direction:0b,allied:0b},pages:[]}

##################################################################
## Tooltips
# Info
replaceitem block ~ ~ ~ container.4 diamond_hoe{display:{Name:'[{"text":"nfgForceField ","color":"gold"},{"text":"Configurator ","color":"white"},{"text":"Help","color":"aqua"}]',Lore:['{"text":" "}','[{"text":"Configure ","color":"white"},{"text":"Entering","color":"green"},{"text":"/"},{"text":"Outgoing","color":"dark_red"}]','{"text":"Messages & Potions for both ","color":"white"}','[{"text":"Allied ","color":"green"},{"text":"& ","color":"white"},{"text":"Strangers","color":"yellow"},{"text":" of a ","color":"white"},{"text":"ForceField","color":"gold"},{"text":".","color":"white"}]']},HideFlags:127,CustomModelData:255000,ff:{config:1b}}
# Allied Entering
