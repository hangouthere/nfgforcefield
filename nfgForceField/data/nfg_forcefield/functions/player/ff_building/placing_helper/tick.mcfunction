...
# Update Screen
title @p[tag=ff_building] actionbar [{"text":"Min: ","color":"yellow"},{"score":{"name":"#_areaMin","objective":"ff_calcs"},"color":"white"},{"text":" | "},{"text":"Δ: ","color":"dark_purple"},{"score":{"name":"#_area","objective":"nfg_calcs"},"color":"aqua"}]
