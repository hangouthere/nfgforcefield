...
execute at @s run function nfg_forcefield:corners/configured/security/stranger/motion_calc
...
function nfg_forcefield:corners/configured/security/stranger/motion_apply
