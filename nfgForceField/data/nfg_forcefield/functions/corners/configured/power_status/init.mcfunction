...
execute if entity @s[tag=ff_power_on] run function nfg_forcefield:corners/configured/power_status/power_on
execute if entity @s[tag=ff_power_off] run function nfg_forcefield:corners/configured/power_status/power_off
