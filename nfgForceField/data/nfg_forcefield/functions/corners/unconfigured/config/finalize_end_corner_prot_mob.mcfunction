...
data modify entity @s ArmorItems[0].tag._ff.type set value "Mob"

# Mark paired Ending Corner with the Protection Type
execute as @e[tag=ff_corner,tag=!ff_configured,tag=ff_end] run data modify entity @s ArmorItems[0].tag._ff.type set value "Mob"
