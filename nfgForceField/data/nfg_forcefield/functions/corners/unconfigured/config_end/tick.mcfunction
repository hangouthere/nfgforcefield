...
data modify storage nfg:forcefield operations.meta.placing_ff set from entity @e[tag=ff_building_helper,sort=nearest,limit=1] ArmorItems[0].tag
...
data modify storage nfg:forcefield operations.meta.search.found_ff set from storage nfg:forcefield operations.meta.placing_ff
...
data modify storage nfg:forcefield operations.create append from storage nfg:forcefield operations.meta.placing_ff

# Add ForceField to storage `ForceField` array for persistence and scans!
data modify storage nfg:forcefield ForceFields append from storage nfg:forcefield operations.meta.placing_ff
