...
data modify storage nfg:forcefield operations.create append from storage nfg:forcefield operations.meta

# Add ForceField to storage `ForceField` array for persistence and scans!
data modify storage nfg:forcefield ForceFields append from storage nfg:forcefield operations.meta
