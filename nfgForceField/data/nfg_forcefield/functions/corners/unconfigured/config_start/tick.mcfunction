data modify storage nfg:forcefield operations.meta.search.list set from storage nfg:forcefield operations.create
...
execute if data storage nfg:forcefield operations.meta.search.found_ff run function nfg_forcefield:corners/unconfigured/config_start/apply_config
