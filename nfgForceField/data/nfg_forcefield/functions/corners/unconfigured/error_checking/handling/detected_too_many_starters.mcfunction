...
#####################################
# Started as: execute as @e[tag=ff_corner] at @s | execute if score #_numUncfgStart ff_calcs matches 2..

# Tell user about error, provide click solution...
tellraw @p [{"text":"[nfgForceField] ","color":"gold"},{"text":"Error","color":"red"},{"text":": ","color":"white"},{"text":"Too many Starting Corners placed! Destroy previous Corners? ","color":"white"},{"text":"["},{"text":"Yes","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"Warning","color":"yellow"},{"text":": "},{"text":"This will reset unfinished ","color":"white"},{"text":"ForceFields","color":"gold"},{"text":"!"}]},"clickEvent":{"action":"run_command","value":"/function nfg_forcefield:corners/unconfigured/uninit"}},{"text":"]","hoverEvent":{"action":"show_text","contents":[{"text":"","color":"yellow"}]}}]
