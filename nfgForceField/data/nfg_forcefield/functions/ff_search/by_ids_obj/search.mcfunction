# Find FF by ID
#
# operations.meta.search.list - Required - Array to loop through and compare/find by `IDs` property
#
# Example:
...
data modify storage nfg:forcefield operations.meta.search.currIdx set from storage nfg:forcefield operations.meta.search.list[0].IDs

# Do ID compare...
execute store success score #_search_found_id ff_calcs run data modify storage nfg:forcefield operations.meta.search.currIdx set from storage nfg:forcefield operations.meta.search.target.IDs
