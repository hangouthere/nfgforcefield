...
execute as @e[tag=ff_corner,tag=ff_configured] at @s if entity @p[distance=..16] facing entity @p[distance=..16] eyes run tp @s ^ ^ ^ ~ ~

schedule function nfg_forcefield:scheduled/corners/target_player/tick 10t replace
