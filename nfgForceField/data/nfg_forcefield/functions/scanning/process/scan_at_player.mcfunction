...
execute if score #DEBUG _ff_calcs matches 1 run say Scan @ Player %%
...
execute if entity @s[tag=ff_thread_processed] run scoreboard players set #_scan_stateMobSearch _ff_calcs 2
