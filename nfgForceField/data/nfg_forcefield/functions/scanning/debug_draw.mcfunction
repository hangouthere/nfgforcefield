...
execute at @e[scores={ff_scan_track=1..}] run particle dust 0.725 0.243 0.443 0.5 ~ ~2.125 ~ 0 0 0 0 20
execute at @e[scores={ff_scan_kill=0}] run particle dust 0.035 1 0 0.5 ~ ~3 ~ 0 0 0 0 20
execute at @e[scores={ff_scan_kill=1..}] run particle dust 1 0 0 0.5 ~ ~3 ~ 0 0 0 0 20
