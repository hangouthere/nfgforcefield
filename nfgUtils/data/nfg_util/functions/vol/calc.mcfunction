...
execute if score #_vol_x _nfg_calcs matches ..0 run scoreboard players operation #_vol_x _nfg_calcs *= #_-1 _nfg_const
execute if score #_vol_y _nfg_calcs matches ..0 run scoreboard players operation #_vol_y _nfg_calcs *= #_-1 _nfg_const
execute if score #_vol_z _nfg_calcs matches ..0 run scoreboard players operation #_vol_z _nfg_calcs *= #_-1 _nfg_const
