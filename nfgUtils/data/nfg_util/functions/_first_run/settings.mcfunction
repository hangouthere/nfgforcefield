...
scoreboard objectives remove nfg_calcs
scoreboard objectives remove nfg_settings
# Constants
...
scoreboard objectives add nfg_calcs dummy
...
scoreboard players set #_nfgNextPlayerId nfg_calcs 1
# Mark DEBUG Off by default
scoreboard players set DEBUG nfg_settings 0
